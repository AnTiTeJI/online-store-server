...
import { HasOneGetAssociationMixin, BelongsToManyCreateAssociationMixin, BelongsToManyGetAssociationsMixin, HasManyCreateAssociationMixin, HasManyGetAssociationsMixin, HasOneCreateAssociationMixin, Model, Optional, BelongsToManyAddAssociationMixin } from "sequelize/dist";
...
export interface ProductModel extends Model<ProductAttributes, ProductCreationAttibutes>, ProductAttributes {
    ...
    addCharacteristic: BelongsToManyAddAssociationMixin<CharacteristicModel, CharacteristicModel>,
...
export interface ImageModel extends Model<ImageAttributes, ImageCreationAttributes>, ImageAttributes { }
...
export interface PreferenceModel extends Model<PreferenceAttributes, PreferenceCreationAttributes>, PreferenceAttributes { }
...
interface CharacteristicCreationAttributes extends Optional<CharacteristicAttributes, "id"> { }
export interface CharacteristicModel extends Model<CharacteristicAttributes, CharacteristicCreationAttributes>, CharacteristicAttributes { }
...
interface TemplateCreationAttibutes extends Optional<TemplateAttributes, "id"> { }
export interface TemplateModel extends Model<TemplateAttributes, TemplateCreationAttibutes>, TemplateAttributes { }